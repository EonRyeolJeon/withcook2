...
public class jeoncook1 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jeoncook1);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        int beforered =  rgbset.getBeforered();
        int beforegreen =  rgbset.getBeforegreen();
        int beforeblue =  rgbset.getBeforeblue();
        int nextred =  rgbset.getBeforered();
        int nextgreen =  rgbset.getBeforegreen();
        int nextblue =  rgbset.getBeforeblue();
    ...
    private void showDialogForPermission(String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder( jeoncook1.this);
        builder.setTitle("알림");
